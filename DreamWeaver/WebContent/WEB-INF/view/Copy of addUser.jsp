        ...
        <br>
           ...
           <td>
			...
			<td width="90">
					 <span style="color:red;font-size:15" id="weixingSpan1">*</span>
						...
						<tr>
			<td>
				     <span class="font1">汇&nbsp;款&nbsp;备&nbsp;注:</span>
           </td>
           <td>
             <input value="${requestScope.user.info}" class="text" type="text" name="user.info" id="info" >
			</td>
			<td width="90">
			...
			<select style="margin-left:23%"  id="info" name="fuid" class="text3" >
           ...
           <td>
             <!-- <input class="text" type="text" name="user.level"  > -->
			    ...
			    <s:if test='%{#session.user.level=="CEO"||#session.user.level=="0"}'>
			    <option>CEO</option>
			    <option>官方</option>
			    <option>总代</option>
			    <option>一级</option>
			    ...
			    <s:if test='%{#session.user.level=="三级"}'>
			    <option>三级</option>
				 <option>特约</option>
			    </s:if>
