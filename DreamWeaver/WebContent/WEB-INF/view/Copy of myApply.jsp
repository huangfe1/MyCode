      ...
      <tr>
        ...
        <td bgcolor="#e5f1d6">
          ...
          <s:iterator value="applys" status="sta" var="apply">
			...
			<td><div align='center' class='STYLE1'><s:if test="#apply.status==0"><s:if test="type==0"><a href="#" onclick="if(confirm('确定删除?')){location.href='deleteapply?aid=${apply.aid}'}">点击删除</a></s:if><s:else><span style="color:blue"><a  href='enterApplyjsp?aid=${apply.aid}&name=${apply.sname}&gname=${apply.gname}&type=0' class='STYLE2' ><span style="color:blue">点击处理</span></a></span></s:else></s:if><s:else><span style="color:green"><a href="applyinfo?aid=${aid}">已经处理</a></span></s:else></div></td>
			</tr>
          </s:iterator>
          </table>
           </form>
