              ...
              <!-- 产品名称 -->
	         	  <tr align="center" style="height: 0"> 
	         	     <td align='left' >
	         	     	...
	         	     	<%-- <td colspan="2">
	         	     		<span style="display:none" class='font1'>代理公司：</span><span class='font1'>
	         	     	</td>
	         	     	<td colspan="2">
	         	     		<span style="display:none"  class='font1'>美&nbsp;容&nbsp;院：</span>
	         	     	</td> --%>
	         	 </tr>
	     <!--     	 <tr align="center">
	         	 	
	         	    <td colspan="2">
                   <input style="display: none" type='text' name="company" class='text5' id='agentId'>
	         	    </td>
	         	    <td colspan="2">
	         	     	<input style="display: none" type='text' name="parlour" class='text5' id='beautyId'>
	         	    </td>
	         	  </tr> -->
				 <!-- 指定代理 -->
				     <tr align="left">
            ...
            placeholder="代理编号">
			      ...
			      <tr><td colspan="6"  align="center"><span class="font1" style="color:white"><s:property value="msg"/></span></td></tr>
	         </table>
		   </form>
		   </div>
		</body>
