...
<div id="mainDiv">
	<div id="content">
		<div id="code">
			...
			<span class="placeholder"/><span class="comments">//Tz曾说过,其实你只要等着就好</span><br /><br />
			<span class="placeholder"/><span class="comments">//顺其自然,不急不躁,努力总会有结果,否则只会弄巧成拙</span><br /><br />
			<span class="placeholder"/> A gril said to me you just need wait,everything will be ok.but I make things wrong because that I didn't do as it<br /><br />
			<span class="comments">//筑美感谢一路走来大家的关爱</span><br /><br />
			<span class="comments">//渐渐的开始回馈大家..;</span><br /><br />
			<br>
			<br>
		
			<!--Baby, I love you forever;-->
			<b>筑梦者携公司全体对您表示再次衷心的感谢</b>
			<br />
		</div>
		<div id="loveHeart">
